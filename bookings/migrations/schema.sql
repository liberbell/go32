...
\restrict NKPfWuyjNbIfIxTuCY941PhPtD5mPrATqGB0FsZBxXa8cRhAVklPl0DrB3SKQuI
...
--
-- Name: rooms; Type: TABLE; Schema: public; Owner: bookings_ope
--
...
ALTER TABLE public.rooms OWNER TO bookings_ope;

--
-- Name: rooms_id_seq; Type: SEQUENCE; Schema: public; Owner: bookings_ope
--
...
ALTER SEQUENCE public.rooms_id_seq OWNER TO bookings_ope;

--
-- Name: rooms_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: bookings_ope
--
...
--
-- Name: rooms rooms_pkey; Type: CONSTRAINT; Schema: public; Owner: bookings_ope
--
...
--
-- Name: reservations_email_idx; Type: INDEX; Schema: public; Owner: bookings_ope
--
...
--
-- Name: reservations_last_name_idx; Type: INDEX; Schema: public; Owner: bookings_ope
--
...
--
-- Name: users_email_idx; Type: INDEX; Schema: public; Owner: bookings_ope
--
...
--
-- Name: room_restrictions room_restrictions_reservations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: bookings_ope
--
...
--
-- Name: room_restrictions room_restrictions_restrictions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: bookings_ope
--
...
--
-- Name: room_restrictions room_restrictions_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: bookings_ope
--
...
\unrestrict NKPfWuyjNbIfIxTuCY941PhPtD5mPrATqGB0FsZBxXa8cRhAVklPl0DrB3SKQuI
